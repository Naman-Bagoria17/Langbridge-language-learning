...
function CallButton({ handleVideoCall, friend }) {
  return (
    <div className="p-4 bg-base-100 border-b border-base-content/10 flex items-center justify-between w-full absolute top-0 z-20 shadow-sm">
      ...
      {friend && (
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div>
              <h3 className="font-semibold text-base-content text-sm">{friend.fullName}</h3>
